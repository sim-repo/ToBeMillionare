...
public class OnboardKit : NSObject {
    ...
    @objc dynamic public class func drawOnboardMeteoritView(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 414, height: 896), resizing: ResizingBehavior = .aspectFit, onboardAnimation: CGFloat = 0.2) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
    ...
    @objc dynamic public class func drawOnboardCosmos(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 414, height: 896), resizing: ResizingBehavior = .aspectFit, moveToOnboard: CGFloat = 1, onboardAnimation: CGFloat = 0.2, onboardOffset: CGFloat = 1) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
    ...
    @objc dynamic public class func drawOnboardSpaceship1(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 414, height: 896), resizing: ResizingBehavior = .aspectFit, moveToOnboard: CGFloat = 1, onboardAnimation: CGFloat = 0.2, onboardOffset: CGFloat = 1) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        ...
        let paint0_linear4Color2 = UIColor(red: 0.249, green: 0.209, blue: 0.952, alpha: 1.000)
        let color = UIColor(red: 1.000, green: 0.000, blue: 0.000, alpha: 0.000)
        let gradient2Color = UIColor(red: 0.016, green: 0.343, blue: 0.561, alpha: 1.000)
        let color3 = UIColor(red: 0.091, green: 0.000, blue: 0.314, alpha: 1.000)
        ...
        let commandCenter = UIImage(named: "commandCenter.png")!
        ...
        let smallBallDialogMovingExp: CGFloat = onboardAnimation < 0.1 ? 200 : (onboardAnimation >= 0.1 && onboardAnimation <= 0.2 ? 200 + (onboardAnimation - 0.1) * 120 : 200 + (0.2 - 0.1) * 120)
        let dialogRectMovingExp: CGFloat = onboardAnimation < 0.1 ? 160 : (onboardAnimation >= 0.1 && onboardAnimation <= 0.2 ? 160 - (onboardAnimation - 0.1) * 180 : 160 - (0.2 - 0.1) * 180)
        let spaceshipOpacity1: CGFloat = onboardAnimation < 0.8 ? 1 : 0
        let dialogSpaceship = onboardAnimation >= 0.1 && onboardAnimation < 0.11 ? "Хьюстон, это\nЗонд-1, прием.." : (onboardAnimation >= 0.12 && onboardAnimation < 0.13 ? "Основные испытания \nзакончены. Осталось сделать несколько\nфотоснимков и приступаем к фазе возвращения на Землю.." : (onboardAnimation >= 0.14 && onboardAnimation < 0.15 ? "Еще бы.. жена сказала, что меня домой не пустит без этого фото.. " : (onboardAnimation >= 0.16 && onboardAnimation < 0.17 ? "На каком расстоянии? Доложите расчетное время до столкновения." : (onboardAnimation >= 0.18 && onboardAnimation < 0.19 ? "Зонд-1: Внимание всему экипажу, двигатели на максимальную!" : (onboardAnimation >= 0.19 && onboardAnimation <= 0.2 ? "Не успеваем! Аааа..." : (onboardAnimation >= 1.1 && onboardAnimation <= 1.15 ? "Да, все живы. Но похоже корабль сильно поврежден. Нам потребуется время, чтобы его восстановить" : ""))))))
        let dialogSpaceshipOpacity: CGFloat = onboardAnimation >= 0.1 && onboardAnimation < 0.11 || onboardAnimation >= 0.12 && onboardAnimation < 0.13 || onboardAnimation >= 0.14 && onboardAnimation < 0.15 || onboardAnimation >= 0.16 && onboardAnimation < 0.17 || onboardAnimation >= 0.18 && onboardAnimation < 0.19 || onboardAnimation >= 0.19 && onboardAnimation <= 0.2 || onboardAnimation >= 1.1 && onboardAnimation <= 1.15 ? 1 : 0
        let dialogCommandCenter = onboardAnimation >= 0.11 && onboardAnimation < 0.12 ? "Это Хьюстон, вас слышу\nпрекрасно. Доложите об\nстатусе исследования планеты Нептун.. прием.." : (onboardAnimation >= 0.13 && onboardAnimation < 0.14 ? "Вас понял. Не забудьте сделать селфи на фоне Нептуна.. ахаха" : (onboardAnimation >= 0.15 && onboardAnimation < 0.16 ? "Внимание, Зонд-1. Заметил странный приближающийся объект, летящий в вашу сторону!" : (onboardAnimation >= 0.17 && onboardAnimation < 0.18 ? "Хьюстон: Летит с огромной скоростью прямо на вас.. Срочно уходите в сторону!" : (onboardAnimation >= 1 && onboardAnimation < 1.1 ? "Хьюстон: Зонд-1, вы целы?" : (onboardAnimation >= 1.15 && onboardAnimation <= 1.2 ? "Хьюстон: Наши радары показывают, что это еще не все... К вам также движется целая группа астеройдов на расстоянии 30-и земных суток от вас. Сейчас они проходят как раз мимо Меркурия" : "")))))
        let dialogCommandOpacity: CGFloat = onboardAnimation >= 0.11 && onboardAnimation < 0.12 || onboardAnimation >= 0.13 && onboardAnimation < 0.14 || onboardAnimation >= 0.15 && onboardAnimation < 0.16 || onboardAnimation >= 0.17 && onboardAnimation < 0.18 || onboardAnimation >= 1 && onboardAnimation < 1.1 || onboardAnimation >= 1.15 && onboardAnimation <= 1.2 ? 1 : 0
        let commandOpacity: CGFloat = onboardAnimation >= 0.11 && onboardAnimation < 0.18 || onboardAnimation >= 1 && onboardAnimation <= 1.2 ? 1 : 0
        ...
        //// Mask 2 Drawing
        context.saveGState()
        context.translateBy(x: -0.18, y: 0.05)
        context.scaleBy(x: 1, y: expression4)
        ...
        //// Mask 3 Drawing
        context.saveGState()
        context.translateBy(x: 1.69, y: 30.99)
        context.scaleBy(x: 1, y: 1.6)
        ...
        //// Oval Drawing
        context.saveGState()
        context.setAlpha(dialogSpaceshipOpacity)

        let ovalPath = UIBezierPath(ovalIn: CGRect(x: 245.71, y: 244.92, width: 18, height: 18))
        color3.setFill()
        ovalPath.fill()
        ...
        //// Group 2
        context.saveGState()
        context.translateBy(x: dialogRectMovingExp, y: 266.23)
        ...
        let rectanglePath = UIBezierPath(roundedRect: CGRect(x: 0, y: 0, width: 217.3, height: 109.66), cornerRadius: 20)
        color3.setFill()
        rectanglePath.fill()
        OnboardKit.gradientColor2.setStroke()
        ...
        let textRect = CGRect(x: 7.68, y: 3.82, width: 206.73, height: 102.48)
        let textStyle = NSMutableParagraphStyle()
        textStyle.alignment = .left
        let textFontAttributes = [
            .font: UIFont(name: "Play", size: 12)!,
            .foregroundColor: UIColor.white,
            .paragraphStyle: textStyle,
        ] as [NSAttributedString.Key: Any]
        ...
        let oval2Path = UIBezierPath(ovalIn: CGRect(x: (smallBallDialogMovingExp + 36.5986328125), y: 233.41, width: 11.04, height: 10.4))
        color3.setFill()
        oval2Path.fill()
        ...
        //// Command Group
        context.saveGState()
        context.setAlpha(commandOpacity)
        context.beginTransparencyLayer(auxiliaryInfo: nil)


        //// Oval 9 Drawing
        let oval9Path = UIBezierPath(ovalIn: CGRect(x: 225.15, y: 476.11, width: 150, height: 153))
        ...
        //// Command Drawing
        context.saveGState()
        context.translateBy(x: 271.05, y: 520.19)
        context.scaleBy(x: 0.6, y: 0.6)

        let commandPath = UIBezierPath(rect: CGRect(x: 0, y: 0, width: 144, height: 141))
        context.saveGState()
        commandPath.addClip()
        context.translateBy(x: 0, y: 0)
        context.scaleBy(x: 1, y: -1)
        context.translateBy(x: 0, y: -commandCenter.size.height)
        context.draw(commandCenter.cgImage!, in: CGRect(x: 0, y: 0, width: commandCenter.size.width, height: commandCenter.size.height))
        context.restoreGState()
        ...
        //// Rectangle 2 Drawing
        context.saveGState()
        context.setAlpha(dialogCommandOpacity)
        context.beginTransparencyLayer(auxiliaryInfo: nil)

        let rectangle2Path = UIBezierPath(roundedRect: CGRect(x: 118.67, y: 376.58, width: 222.82, height: 109.66), cornerRadius: 20)
        color3.setFill()
        rectangle2Path.fill()
        OnboardKit.gradientColor2.setStroke()
        ...
        let text2Rect = CGRect(x: 129, y: 379.73, width: 205.06, height: 102.48)
        ...
        let text2TextHeight: CGFloat = dialogCommandCenter.boundingRect(with: CGSize(width: text2Rect.width, height: CGFloat.infinity), options: .usesLineFragmentOrigin, attributes: text2FontAttributes, context: nil).height
        context.saveGState()
        context.clip(to: text2Rect)
        dialogCommandCenter.draw(in: CGRect(x: text2Rect.minX, y: text2Rect.minY + (text2Rect.height - text2TextHeight) / 2, width: text2Rect.width, height: text2TextHeight), withAttributes: text2FontAttributes)
        context.restoreGState()
        ...
        let oval10Path = UIBezierPath(ovalIn: CGRect(x: 255.87, y: 493.25, width: 18, height: 18))
        color3.setFill()
        oval10Path.fill()
        ...
        let oval11Path = UIBezierPath(ovalIn: CGRect(x: 275.71, y: 514.58, width: 11.04, height: 10.4))
        color3.setFill()
        oval11Path.fill()
    ...
    @objc dynamic public class func drawOnboardSpaceship3(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 414, height: 896), resizing: ResizingBehavior = .aspectFit, onboardAnimation: CGFloat = 0.2, onboardOffset: CGFloat = 1) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        ...
        let rectanglePath = UIBezierPath(roundedRect: CGRect(x: 160.11, y: 266.23, width: 217.3, height: 109.66), cornerRadius: 20)
        color3.setFill()
        rectanglePath.fill()
        OnboardKit.gradientColor2.setStroke()
        rectanglePath.lineWidth = 1
        ...
        let textRect = CGRect(x: 167.79, y: 270.05, width: 206.73, height: 102.48)
        let textStyle = NSMutableParagraphStyle()
        textStyle.alignment = .left
        let textFontAttributes = [
            .font: UIFont(name: "Play", size: 12)!,
        ...
        let ovalPath = UIBezierPath(ovalIn: CGRect(x: 256.39, y: 242.87, width: 18, height: 18))
        color3.setFill()
        ovalPath.fill()
        ...
        let oval2Path = UIBezierPath(ovalIn: CGRect(x: 249.23, y: 229.1, width: 11.04, height: 10.4))
        color3.setFill()
        oval2Path.fill()
        ...
        //// Oval 9 Drawing
        let oval9Path = UIBezierPath(ovalIn: CGRect(x: 225.06, y: 476.11, width: 150, height: 153))
        gradient2Color.setFill()
        oval9Path.fill()
        ...
        //// Command Drawing
        context.saveGState()
        context.translateBy(x: 270.96, y: 520.19)
        context.scaleBy(x: 0.6, y: 0.6)
        ...
        let rectangle2Path = UIBezierPath(roundedRect: CGRect(x: 118.58, y: 376.58, width: 222.82, height: 109.66), cornerRadius: 20)
        color3.setFill()
        rectangle2Path.fill()
        OnboardKit.gradientColor2.setStroke()
        rectangle2Path.lineWidth = 1
        ...
        let text2Rect = CGRect(x: 128.91, y: 379.73, width: 205.06, height: 102.48)
        let text2Style = NSMutableParagraphStyle()
        text2Style.alignment = .left
        let text2FontAttributes = [
            .font: UIFont(name: "Play", size: 12)!,
        ...
        let oval10Path = UIBezierPath(ovalIn: CGRect(x: 255.78, y: 493.25, width: 18, height: 18))
        color3.setFill()
        oval10Path.fill()
        ...
        let oval11Path = UIBezierPath(ovalIn: CGRect(x: 275.62, y: 514.58, width: 11.04, height: 10.4))
        color3.setFill()
        oval11Path.fill()
    ...
    @objc dynamic public class func drawOnboardCosmosDust(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 414, height: 896), resizing: ResizingBehavior = .aspectFit, onboardAnimation: CGFloat = 0.2) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
    ...
    @objc dynamic public class func drawOnboardExplosion(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 414, height: 896), resizing: ResizingBehavior = .aspectFit, onboardAnimation: CGFloat = 0.2) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        ...
        //// Rectangle 3 Drawing
        context.saveGState()
        context.translateBy(x: -17.35, y: 269.38)

        context.saveGState()
        context.setAlpha(explosiveOpacity)

        let rectangle3Path = UIBezierPath(roundedRect: CGRect(x: explosiveDetail1.x, y: (explosiveDetail1.y + 0.624674479167), width: 3, height: 3), cornerRadius: 1.5)
        starGradientColor.setFill()
        rectangle3Path.fill()
    ...
    @objc dynamic public class func drawCanvas1(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 1, height: 2), resizing: ResizingBehavior = .aspectFit) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        
        //// Resize to Target Frame
        context.saveGState()
        let resizedFrame: CGRect = resizing.apply(rect: CGRect(x: 0, y: 0, width: 1, height: 2), target: targetFrame)
        context.translateBy(x: resizedFrame.minX, y: resizedFrame.minY)
        context.scaleBy(x: resizedFrame.width / 1, y: resizedFrame.height / 2)


        //// Color Declarations
        let fillColor25 = UIColor(red: 0.000, green: 0.710, blue: 0.000, alpha: 1.000)

        //// Bezier 277 Drawing
        let bezier277Path = UIBezierPath()
        bezier277Path.move(to: CGPoint(x: 0.75, y: 0.83))
        bezier277Path.addCurve(to: CGPoint(x: 0.67, y: 0.65), controlPoint1: CGPoint(x: 0.75, y: 0.73), controlPoint2: CGPoint(x: 0.75, y: 0.67))
        bezier277Path.addCurve(to: CGPoint(x: 0.37, y: 0.75), controlPoint1: CGPoint(x: 0.59, y: 0.63), controlPoint2: CGPoint(x: 0.52, y: 0.65))
        bezier277Path.addLine(to: CGPoint(x: 0.37, y: 0.75))
        bezier277Path.addCurve(to: CGPoint(x: 0.08, y: 0.99), controlPoint1: CGPoint(x: 0.26, y: 0.8), controlPoint2: CGPoint(x: 0.16, y: 0.89))
        bezier277Path.addLine(to: CGPoint(x: 0.08, y: 0.99))
        bezier277Path.addCurve(to: CGPoint(x: 0, y: 1.25), controlPoint1: CGPoint(x: 0.03, y: 1.06), controlPoint2: CGPoint(x: -0, y: 1.16))
        bezier277Path.addLine(to: CGPoint(x: 0, y: 1.8))
        bezier277Path.addCurve(to: CGPoint(x: 0.07, y: 1.99), controlPoint1: CGPoint(x: 0, y: 1.9), controlPoint2: CGPoint(x: 0, y: 1.96))
        bezier277Path.addCurve(to: CGPoint(x: 0.37, y: 1.9), controlPoint1: CGPoint(x: 0.14, y: 2.02), controlPoint2: CGPoint(x: 0.23, y: 1.99))
        bezier277Path.addLine(to: CGPoint(x: 0.37, y: 1.9))
        bezier277Path.addCurve(to: CGPoint(x: 0.67, y: 1.65), controlPoint1: CGPoint(x: 0.48, y: 1.84), controlPoint2: CGPoint(x: 0.59, y: 1.76))
        bezier277Path.addLine(to: CGPoint(x: 0.67, y: 1.65))
        bezier277Path.addCurve(to: CGPoint(x: 0.75, y: 1.36), controlPoint1: CGPoint(x: 0.72, y: 1.56), controlPoint2: CGPoint(x: 0.75, y: 1.46))
        bezier277Path.addLine(to: CGPoint(x: 0.75, y: 0.83))
        bezier277Path.close()
        bezier277Path.move(to: CGPoint(x: 0.22, y: 1.13))
        bezier277Path.addLine(to: CGPoint(x: 0.22, y: 1.13))
        bezier277Path.addCurve(to: CGPoint(x: 0.33, y: 0.88), controlPoint1: CGPoint(x: 0.21, y: 1.03), controlPoint2: CGPoint(x: 0.25, y: 0.94))
        bezier277Path.addLine(to: CGPoint(x: 0.38, y: 0.88))
        bezier277Path.addLine(to: CGPoint(x: 0.45, y: 0.88))
        bezier277Path.addCurve(to: CGPoint(x: 0.5, y: 0.88), controlPoint1: CGPoint(x: 0.45, y: 0.88), controlPoint2: CGPoint(x: 0.45, y: 0.88))
        bezier277Path.addCurve(to: CGPoint(x: 0.5, y: 0.98), controlPoint1: CGPoint(x: 0.55, y: 0.88), controlPoint2: CGPoint(x: 0.5, y: 0.93))
        bezier277Path.addLine(to: CGPoint(x: 0.5, y: 1.53))
        bezier277Path.addLine(to: CGPoint(x: 0.5, y: 1.53))
        bezier277Path.addLine(to: CGPoint(x: 0.5, y: 1.53))
        bezier277Path.addCurve(to: CGPoint(x: 0.44, y: 1.75), controlPoint1: CGPoint(x: 0.51, y: 1.61), controlPoint2: CGPoint(x: 0.48, y: 1.69))
        bezier277Path.addLine(to: CGPoint(x: 0.36, y: 1.81))
        bezier277Path.addLine(to: CGPoint(x: 0.3, y: 1.81))
        bezier277Path.addLine(to: CGPoint(x: 0.3, y: 1.81))
        bezier277Path.addCurve(to: CGPoint(x: 0.24, y: 1.67), controlPoint1: CGPoint(x: 0.3, y: 1.81), controlPoint2: CGPoint(x: 0.24, y: 1.81))
        bezier277Path.addLine(to: CGPoint(x: 0.24, y: 1.67))
        bezier277Path.addLine(to: CGPoint(x: 0.22, y: 1.13))
        bezier277Path.close()
        fillColor25.setFill()
        bezier277Path.fill()
    ...
    @objc dynamic public class func drawCanvas2(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 1, height: 2), resizing: ResizingBehavior = .aspectFit) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        ...
        bezier275Path.move(to: CGPoint(x: 0.15, y: 0.79))
        bezier275Path.addLine(to: CGPoint(x: 0, y: 0.88))
        bezier275Path.addLine(to: CGPoint(x: 0, y: 2))
        bezier275Path.addLine(to: CGPoint(x: 0.22, y: 1.88))
        bezier275Path.addLine(to: CGPoint(x: 0.22, y: 0.93))
        bezier275Path.addLine(to: CGPoint(x: 0.22, y: 0.93))
        bezier275Path.addCurve(to: CGPoint(x: 0.32, y: 0.93), controlPoint1: CGPoint(x: 0.25, y: 0.94), controlPoint2: CGPoint(x: 0.29, y: 0.94))
        bezier275Path.addLine(to: CGPoint(x: 0.32, y: 0.93))
        bezier275Path.addCurve(to: CGPoint(x: 0.45, y: 0.87), controlPoint1: CGPoint(x: 0.37, y: 0.92), controlPoint2: CGPoint(x: 0.41, y: 0.9))
        bezier275Path.addLine(to: CGPoint(x: 0.45, y: 0.78))
        bezier275Path.addLine(to: CGPoint(x: 0.28, y: 0.84))
        bezier275Path.addLine(to: CGPoint(x: 0.28, y: 0.84))
        bezier275Path.addCurve(to: CGPoint(x: 0.15, y: 0.79), controlPoint1: CGPoint(x: 0.23, y: 0.84), controlPoint2: CGPoint(x: 0.19, y: 0.82))
        bezier275Path.addLine(to: CGPoint(x: 0.15, y: 0.79))
        bezier275Path.close()
        fillColor25.setFill()
        bezier275Path.fill()
