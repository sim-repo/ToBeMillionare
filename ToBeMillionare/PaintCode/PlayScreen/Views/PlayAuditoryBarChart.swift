...
class PlayAuditoryBarChart: UIView {
       ...
       override func draw(_ rect: CGRect) {
           PlayScreenV2.drawAuditoryBarChart(frame: bounds,
                                             resizing: .aspectFit, auditoryFractionA: curPercentColA, auditoryFractionB: curPercentColB, auditoryFractionC: curPercentColC, auditoryFractionD: curPercentColD, auditoryChartMaxHeight: columnMaxHeight)
       }
       
       
       func start(fractionPercentA: CGFloat, fractionPercentB: CGFloat, fractionPercentC: CGFloat, fractionPercentD: CGFloat) {
