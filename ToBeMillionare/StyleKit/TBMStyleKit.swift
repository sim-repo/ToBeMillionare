...
public class TBMStyleKit : NSObject {
    ...
    @objc dynamic public class func drawPlay_markCanvas(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 41, height: 41), resizing: ResizingBehavior = .aspectFit) {
        ...
        //// Color Declarations
        let markPGradientColor1 = UIColor(red: 1.000, green: 0.780, blue: 0.459, alpha: 1.000)
    ...
    @objc dynamic public class func drawBottomHoneycombs(frame: CGRect = CGRect(x: 0, y: 0, width: 395, height: 154)) {
        //// General Declarations
        ...
        let strokeColor4 = UIColor(red: 0.020, green: 0.698, blue: 0.898, alpha: 1.000)


        //// Subframes
        let group2: CGRect = CGRect(x: frame.minX, y: frame.minY, width: fastFloor((frame.width) * 1.00127) + 0.5, height: fastFloor((frame.height) * 1.00000 + 0.5))


        //// Group 2
        //// Bezier Drawing
        let bezierPath = UIBezierPath()
        bezierPath.move(to: CGPoint(x: group2.minX + 0.01065 * group2.width, y: group2.minY + 0.10959 * group2.height))
        bezierPath.addLine(to: CGPoint(x: group2.minX + 0.00000 * group2.width, y: group2.minY + 0.14726 * group2.height))
        bezierPath.addLine(to: CGPoint(x: group2.minX + 0.00133 * group2.width, y: group2.minY + 0.99315 * group2.height))
        bezierPath.addLine(to: CGPoint(x: group2.minX + 0.16644 * group2.width, y: group2.minY + 0.99315 * group2.height))
        bezierPath.addLine(to: CGPoint(x: group2.minX + 0.18908 * group2.width, y: group2.minY + 0.91096 * group2.height))
        bezierPath.addLine(to: CGPoint(x: group2.minX + 0.16245 * group2.width, y: group2.minY + 0.80137 * group2.height))
        bezierPath.addLine(to: CGPoint(x: group2.minX + 0.14647 * group2.width, y: group2.minY + 0.81507 * group2.height))
        bezierPath.addLine(to: CGPoint(x: group2.minX + 0.14248 * group2.width, y: group2.minY + 0.79452 * group2.height))
        bezierPath.addLine(to: CGPoint(x: group2.minX + 0.15313 * group2.width, y: group2.minY + 0.77055 * group2.height))
        bezierPath.addLine(to: CGPoint(x: group2.minX + 0.13848 * group2.width, y: group2.minY + 0.70890 * group2.height))
        bezierPath.addLine(to: CGPoint(x: group2.minX + 0.15446 * group2.width, y: group2.minY + 0.65411 * group2.height))
        bezierPath.addLine(to: CGPoint(x: group2.minX + 0.12650 * group2.width, y: group2.minY + 0.55479 * group2.height))
        bezierPath.addLine(to: CGPoint(x: group2.minX + 0.03995 * group2.width, y: group2.minY + 0.55479 * group2.height))
        bezierPath.addLine(to: CGPoint(x: group2.minX + 0.04794 * group2.width, y: group2.minY + 0.51027 * group2.height))
        bezierPath.addLine(to: CGPoint(x: group2.minX + 0.07324 * group2.width, y: group2.minY + 0.51027 * group2.height))
        bezierPath.addLine(to: CGPoint(x: group2.minX + 0.08788 * group2.width, y: group2.minY + 0.45205 * group2.height))
        bezierPath.addLine(to: CGPoint(x: group2.minX + 0.07324 * group2.width, y: group2.minY + 0.39726 * group2.height))
        bezierPath.addLine(to: CGPoint(x: group2.minX + 0.08522 * group2.width, y: group2.minY + 0.34247 * group2.height))
        bezierPath.addLine(to: CGPoint(x: group2.minX + 0.07324 * group2.width, y: group2.minY + 0.29110 * group2.height))
        bezierPath.addLine(to: CGPoint(x: group2.minX + 0.08522 * group2.width, y: group2.minY + 0.23630 * group2.height))
        bezierPath.addLine(to: CGPoint(x: group2.minX + 0.07324 * group2.width, y: group2.minY + 0.17808 * group2.height))
        bezierPath.addLine(to: CGPoint(x: group2.minX + 0.08788 * group2.width, y: group2.minY + 0.13014 * group2.height))
        bezierPath.addLine(to: CGPoint(x: group2.minX + 0.10919 * group2.width, y: group2.minY + 0.13014 * group2.height))
        bezierPath.addLine(to: CGPoint(x: group2.minX + 0.12517 * group2.width, y: group2.minY + 0.06849 * group2.height))
        ...
        bezierPath.addLine(to: CGPoint(x: group2.minX + 0.07057 * group2.width, y: group2.minY + 0.06507 * group2.height))
        bezierPath.addLine(to: CGPoint(x: group2.minX + 0.04660 * group2.width, y: group2.minY + 0.05822 * group2.height))
        bezierPath.addLine(to: CGPoint(x: group2.minX + 0.03196 * group2.width, y: group2.minY + 0.11301 * group2.height))
        bezierPath.addLine(to: CGPoint(x: group2.minX + 0.01065 * group2.width, y: group2.minY + 0.10959 * group2.height))
        bezierPath.close()
        fillColor2.setFill()
        bezierPath.fill()
        ...
        bezier5Path.close()
        bezier5Path.move(to: CGPoint(x: group2.minX + 0.08902 * group2.width, y: group2.minY + 0.81694 * group2.height))
    ...
    @objc dynamic public class func drawScoreWave(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 370, height: 453), resizing: ResizingBehavior = .aspectFit) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        ...
        bezier3Path.addCurve(to: CGPoint(x: 369, y: -1), controlPoint1: CGPoint(x: 364.5, y: 1.5), controlPoint2: CGPoint(x: 369, y: -1))
        bezier3Path.addCurve(to: CGPoint(x: 356, y: 59), controlPoint1: CGPoint(x: 369, y: -1), controlPoint2: CGPoint(x: 369, y: 33))
        bezier3Path.addCurve(to: CGPoint(x: 317, y: 103), controlPoint1: CGPoint(x: 343, y: 85), controlPoint2: CGPoint(x: 333.75, y: 79.5))
        bezier3Path.addCurve(to: CGPoint(x: 289, y: 153), controlPoint1: CGPoint(x: 300.25, y: 126.5), controlPoint2: CGPoint(x: 311.25, y: 134.25))
        bezier3Path.addCurve(to: CGPoint(x: 228, y: 178), controlPoint1: CGPoint(x: 266.75, y: 171.75), controlPoint2: CGPoint(x: 247.25, y: 157.25))
        bezier3Path.addCurve(to: CGPoint(x: 212, y: 236), controlPoint1: CGPoint(x: 208.75, y: 198.75), controlPoint2: CGPoint(x: 235.75, y: 211.25))
        bezier3Path.addCurve(to: CGPoint(x: 131, y: 273), controlPoint1: CGPoint(x: 188.25, y: 260.75), controlPoint2: CGPoint(x: 149, y: 246))
        bezier3Path.addCurve(to: CGPoint(x: 118, y: 359), controlPoint1: CGPoint(x: 113, y: 300), controlPoint2: CGPoint(x: 142, y: 330))
        bezier3Path.addCurve(to: CGPoint(x: 38, y: 383), controlPoint1: CGPoint(x: 94, y: 388), controlPoint2: CGPoint(x: 63.38, y: 365.88))
        bezier3Path.addCurve(to: CGPoint(x: 1, y: 441), controlPoint1: CGPoint(x: 12.62, y: 400.12), controlPoint2: CGPoint(x: 1, y: 441))
        bezier3Path.addLine(to: CGPoint(x: 0.5, y: -0.5))
        context.saveGState()
        bezier3Path.addClip()
        context.drawLinearGradient(paint0_linear6, start: CGPoint(x: 184.75, y: 441), end: CGPoint(x: 184.75, y: -1), options: [])
        context.restoreGState()


        //// Bezier Drawing
        let bezierPath = UIBezierPath()
        bezierPath.move(to: CGPoint(x: 166, y: 147.5))
        bezierPath.addCurve(to: CGPoint(x: 234, y: 116.5), controlPoint1: CGPoint(x: 174.48, y: 138.78), controlPoint2: CGPoint(x: 216.07, y: 134.67))
        bezierPath.addCurve(to: CGPoint(x: 243, y: 67.5), controlPoint1: CGPoint(x: 238.18, y: 112.27), controlPoint2: CGPoint(x: 234.05, y: 88))
        bezierPath.addCurve(to: CGPoint(x: 290, y: 28.5), controlPoint1: CGPoint(x: 245, y: 47.5), controlPoint2: CGPoint(x: 277.13, y: 56.83))
        bezierPath.addCurve(to: CGPoint(x: 307, y: -23.5), controlPoint1: CGPoint(x: 301.18, y: 3.87), controlPoint2: CGPoint(x: 306.9, y: -13.76))
        bezierPath.addLine(to: CGPoint(x: 307, y: -39.5))
        bezierPath.addCurve(to: CGPoint(x: 370, y: -7.66), controlPoint1: CGPoint(x: 307, y: -39.5), controlPoint2: CGPoint(x: 370.02, y: -9.48))
        bezierPath.addLine(to: CGPoint(x: 370, y: 452.5))
        bezierPath.addLine(to: CGPoint(x: -58, y: 452.5))
        bezierPath.addCurve(to: CGPoint(x: -71, y: 402.5), controlPoint1: CGPoint(x: -57.78, y: 441.95), controlPoint2: CGPoint(x: -72.72, y: 408.25))
        bezierPath.addCurve(to: CGPoint(x: -35, y: 364), controlPoint1: CGPoint(x: -68.19, y: 393.12), controlPoint2: CGPoint(x: -51.33, y: 383.9))
        bezierPath.addCurve(to: CGPoint(x: 47, y: 337.5), controlPoint1: CGPoint(x: -29, y: 347), controlPoint2: CGPoint(x: 39.79, y: 344.5))
        bezierPath.addCurve(to: CGPoint(x: 69, y: 242.5), controlPoint1: CGPoint(x: 80, y: 305.5), controlPoint2: CGPoint(x: 46, y: 275))
        bezierPath.addCurve(to: CGPoint(x: 141, y: 211.5), controlPoint1: CGPoint(x: 80.07, y: 226.86), controlPoint2: CGPoint(x: 122, y: 223))
        bezierPath.addCurve(to: CGPoint(x: 166, y: 147.5), controlPoint1: CGPoint(x: 171.63, y: 192.96), controlPoint2: CGPoint(x: 148.5, y: 165.5))
        bezierPath.close()
        fillColor5.setFill()
        bezierPath.fill()
        ...
        //// Bezier 2 Drawing
        let bezier2Path = UIBezierPath()
        bezier2Path.move(to: CGPoint(x: 304, y: -34))
        bezier2Path.addCurve(to: CGPoint(x: 289.5, y: 29.5), controlPoint1: CGPoint(x: 304, y: -34), controlPoint2: CGPoint(x: 298.5, y: 12.5))
        bezier2Path.addCurve(to: CGPoint(x: 243.5, y: 63.5), controlPoint1: CGPoint(x: 281.25, y: 45.07), controlPoint2: CGPoint(x: 255.5, y: 44.5))
        bezier2Path.addCurve(to: CGPoint(x: 234.5, y: 116.5), controlPoint1: CGPoint(x: 235.5, y: 78.5), controlPoint2: CGPoint(x: 246.5, y: 102.5))
        bezier2Path.addCurve(to: CGPoint(x: 172.5, y: 144.5), controlPoint1: CGPoint(x: 217.5, y: 137.5), controlPoint2: CGPoint(x: 180.5, y: 141.5))
        bezier2Path.addCurve(to: CGPoint(x: 146, y: 206.5), controlPoint1: CGPoint(x: 140.5, y: 156.5), controlPoint2: CGPoint(x: 167.5, y: 182))
        bezier2Path.addCurve(to: CGPoint(x: 71, y: 238), controlPoint1: CGPoint(x: 130.36, y: 224.32), controlPoint2: CGPoint(x: 87.68, y: 221.42))
        bezier2Path.addCurve(to: CGPoint(x: 57.5, y: 325.5), controlPoint1: CGPoint(x: 47.91, y: 260.95), controlPoint2: CGPoint(x: 74.5, y: 302.5))
        bezier2Path.addCurve(to: CGPoint(x: -17.5, y: 343.5), controlPoint1: CGPoint(x: 31.14, y: 358.22), controlPoint2: CGPoint(x: -4.5, y: 333.5))
        bezier2Path.addCurve(to: CGPoint(x: -71.5, y: 440.5), controlPoint1: CGPoint(x: -58.5, y: 334.5), controlPoint2: CGPoint(x: -68.22, y: 432.48))
        context.saveGState()
        context.setShadow(offset: CGSize(width: shadow2.shadowOffset.width * resizedShadowScale, height: shadow2.shadowOffset.height * resizedShadowScale), blur: shadow2.shadowBlurRadius * resizedShadowScale, color: (shadow2.shadowColor as! UIColor).cgColor)
    ...
    @objc dynamic public class func drawScoreBlock(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 26, height: 114), resizing: ResizingBehavior = .aspectFit) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        
        //// Resize to Target Frame
        context.saveGState()
        let resizedFrame: CGRect = resizing.apply(rect: CGRect(x: 0, y: 0, width: 26, height: 114), target: targetFrame)
        context.translateBy(x: resizedFrame.minX, y: resizedFrame.minY)
        context.scaleBy(x: resizedFrame.width / 26, y: resizedFrame.height / 114)
        let resizedShadowScale: CGFloat = min(resizedFrame.width / 26, resizedFrame.height / 114)
        ...
        bezierPath.addLine(to: CGPoint(x: 11, y: 99))
        context.saveGState()
        ...
        //// Oval Drawing
        let ovalPath = UIBezierPath(ovalIn: CGRect(x: 3, y: 91, width: 16, height: 16))
        context.saveGState()
        context.setShadow(offset: CGSize(width: shadow.shadowOffset.width * resizedShadowScale, height: shadow.shadowOffset.height * resizedShadowScale), blur: shadow.shadowBlurRadius * resizedShadowScale, color: (shadow.shadowColor as! UIColor).cgColor)
    ...
    @objc dynamic public class func drawDiamond(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 45, height: 53), resizing: ResizingBehavior = .aspectFit) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        
        //// Resize to Target Frame
        context.saveGState()
        let resizedFrame: CGRect = resizing.apply(rect: CGRect(x: 0, y: 0, width: 45, height: 53), target: targetFrame)
        context.translateBy(x: resizedFrame.minX, y: resizedFrame.minY)
        context.scaleBy(x: resizedFrame.width / 45, y: resizedFrame.height / 53)
        let resizedShadowScale: CGFloat = min(resizedFrame.width / 45, resizedFrame.height / 53)
        ...
        context.saveGState()
        bezierPath.addClip()
        context.drawLinearGradient(kMyMoney_iconCanvasgbezier36, start: CGPoint(x: 20.5, y: -0.37), end: CGPoint(x: 20.5, y: 11.19), options: [])
        context.restoreGState()
        ...
        context.saveGState()
        bezier2Path.addClip()
        context.drawLinearGradient(kMyMoney_iconCanvasgbezier36, start: CGPoint(x: 7.21, y: -0.37), end: CGPoint(x: 7.21, y: 11.19), options: [])
        context.restoreGState()
        ...
        context.saveGState()
        bezier3Path.addClip()
        context.drawLinearGradient(kMyMoney_iconCanvasgbezier36, start: CGPoint(x: 33.78, y: -0.37), end: CGPoint(x: 33.78, y: 11.19), options: [])
        context.restoreGState()
        ...
        context.saveGState()
        bezier4Path.addClip()
        context.drawLinearGradient(kMyMoney_iconCanvasgbezier36, start: CGPoint(x: 32.66, y: 14.08), end: CGPoint(x: 32.66, y: 39.5), options: [])
        context.restoreGState()
        ...
        context.saveGState()
        bezier5Path.addClip()
        context.drawLinearGradient(kMyMoney_iconCanvasgbezier36, start: CGPoint(x: 20.45, y: 14.14), end: CGPoint(x: 20.45, y: 45.37), options: [])
        context.restoreGState()
        ...
        context.saveGState()
        bezier6Path.addClip()
        context.drawLinearGradient(kMyMoney_iconCanvasgbezier36, start: CGPoint(x: 8.29, y: 14.08), end: CGPoint(x: 8.29, y: 39.36), options: [])
        context.restoreGState()
